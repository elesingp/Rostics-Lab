...
df_info = pd.read_excel(r'\\mosfil02.int.tgr.net\UsersFolders$\gpe9038\Desktop\ROSTICS-LAB\project\clustering\Рестораны (2).xlsx')
df_numbers = pd.read_csv(common_config['kiosk_path'])
df_numbers['event_date'] = pd.to_datetime(df_numbers['event_date'], errors='coerce').dt.strftime('%Y-%m-%d')
...
data.to_csv(r'\\mosfil02.int.tgr.net\UsersFolders$\gpe9038\Desktop\ROSTICS-LAB\project\static\restraunt_clusters.csv')